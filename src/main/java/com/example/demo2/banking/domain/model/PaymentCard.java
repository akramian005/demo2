...
import com.example.demo2.banking.domain.exception.CardNotUsableException;
...
public class PaymentCard {
    ...
    /**
     * Package-private — вызывается только из BankAccount.linkCard() для синхронизации
     * владеющей стороны связи, наружу не отдаём.
     */
